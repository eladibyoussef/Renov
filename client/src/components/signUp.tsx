...
const LoginContainer: React.FC = () => {
  ...
  return (
    <div className='  apearFromRight'>
      ...
      <h3 className="text-black lg:text-sm font-normal text-center text-3xl hidden sm:block ">WELCOME TO RENOVO</h3>
      <h1 className="text-black lg:text-lg font-bold text-center text-3xl">Create an Account to Join</h1>
      </div>
  ...
  <div className=" flex flex-col items-center justify-center  ">
        ...
        <Link to="/login" className="text-sm text-black font-bold ml-1 underline">Log in </Link>
      </div>
      </div>
